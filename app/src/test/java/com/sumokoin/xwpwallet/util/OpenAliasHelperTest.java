...
package com.sumokoin.sumowallet.util;
...
public class OpenAliasHelperTest {
    ...
    private final static String MONERUJO = "oa1:sumorecipient_address=fh2jc6PbQYd4a5PY3ooPMZiPVniMy4MGcjSRBnoBVc1xLmdCHJ6hc98Ess2hpN2mDgPnCAXtDUUbmjWYutRvdoSr2Nps2o5wc; recipient_name=Sumokoin Development; tx_description=Donation to Sumokoin Core Team;";
    ...
    public void quotedSemicolon() {
        Map<String, String> attrs = OpenAliasHelper.parse("oa1:sumoabc=\";\";def=99;");
        assertNotNull(attrs);
    ...
    public void quotes() {
        ...
        attrs = OpenAliasHelper.parse("oa1:sumoabc=\"def\";");
        assertNotNull(attrs);
    ...
    public void duplex() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:sumoabc=def;ghi=jkl;");
        assertNotNull(attrs);
        assertTrue(attrs.get("abc").equals("def"));
    ...
    public void quoteMiddle() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:sumoabc=d\"ef;ghi=jkl;");
        assertNotNull(attrs);
    ...
    public void quoteMalformedValue() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:sumoabc=d\"e;f\";ghi=jkl;");
        assertNull(attrs);
    }
