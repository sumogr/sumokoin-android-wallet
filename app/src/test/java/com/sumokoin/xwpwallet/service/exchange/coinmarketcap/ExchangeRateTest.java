...
public class ExchangeRateTest {
    ...
    public void queryExchangeRate_shouldBeGetMethod()
        ...
        exchangeApi.queryExchangeRate("SUMO", "EUR", mockExchangeCallback);
    ...
    public void queryExchangeRate_wasNotSuccessfulShouldCallOnError()
        ...
        exchangeApi.queryExchangeRate("SUMO", "USD", new ExchangeCallback() {
            @Override
            public void onSuccess(final ExchangeRate exchangeRate) {
                waiter.fail();
                waiter.resume();
    ...
    public void queryExchangeRate_unknownAssetShouldCallOnError()
        ...
        exchangeApi.queryExchangeRate("SUMO", "ABC", new ExchangeCallback() {
            @Override
            public void onSuccess(final ExchangeRate exchangeRate) {
                waiter.fail();
                waiter.resume();
