...
package com.sumokoin.sumowallet.service.exchange.coingecko;

import android.support.annotation.NonNull;
import android.support.annotation.VisibleForTesting;

import com.sumokoin.sumowallet.service.exchange.api.ExchangeApi;
import com.sumokoin.sumowallet.service.exchange.api.ExchangeCallback;
import com.sumokoin.sumowallet.service.exchange.api.ExchangeException;
import com.sumokoin.sumowallet.service.exchange.api.ExchangeRate;
...
public class ExchangeApiImpl implements ExchangeApi {
    ...
    public void queryExchangeRate(@NonNull final String baseCurrency, @NonNull final String quoteCurrency,
        ...
        final boolean sumokoinAssets = inverse;
            ...
            public void onResponse(final Call call, final Response response) throws IOException {
                if (response.isSuccessful()) {
                    try {
                        ...
                        final JSONObject jsonResult = json.getJSONObject("sumokoin");
                        reportSuccess(jsonResult, sumokoinAssets, callback);
    ...
    void reportSuccess(JSONObject jsonObject, boolean sumokoinAssets, ExchangeCallback callback) {
        try {
            final ExchangeRate exchangeRate = new ExchangeRateImpl(jsonObject, sumokoinAssets);
