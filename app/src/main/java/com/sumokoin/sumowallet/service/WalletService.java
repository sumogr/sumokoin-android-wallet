...
package com.sumokoin.sumowallet.service;
...
import com.sumokoin.sumowallet.model.WalletListener;
...
public class WalletService extends Service {
    ...
    private static final long STATUS_UPDATE_INTERVAL = 240000; // sumokoin 240s (blocktime)
    ...
    private void startNotfication() {
        ...
        Notification notification = new NotificationCompat.Builder(this, channelId)
                ...
                .setOngoing(true)
                .setSmallIcon(R.drawable.ic_sumokoin)
