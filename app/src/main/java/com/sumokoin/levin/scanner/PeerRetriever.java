...
package com.sumokoin.levin.scanner;

import com.sumokoin.levin.data.Bucket;
import com.sumokoin.levin.data.Section;
import com.sumokoin.levin.util.HexHelper;
import com.sumokoin.levin.util.LittleEndianDataInputStream;
import com.sumokoin.levin.util.LittleEndianDataOutputStream;
import com.sumokoin.sumowallet.data.NodeInfo;
...
public class PeerRetriever implements Callable<PeerRetriever> {
    ...
    static private Section handshakeRequest() {
        ...
        byte[] networkId = Helper.hexToBytes("0406dfcefc7c274a24d4f38d424460a8"); // sumokoin mainnet network id
